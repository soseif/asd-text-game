export const storyBeats = [
  {
    ...
    "narrativeText": "The subway train sits motionless in the tunnel. The air is a sickening mix of cheap perfume, sweat, and mechanical grease—a sensory assault that makes your stomach churn. The PA system repeats 'Signal Issues' in a rhythmic drone. This has shattered the absolute order of your '8:00 AM Clock-in' rule. To you, rules aren't suggestions; they are laws of physics. As the law breaks, your body begins to betrayed you with involuntary tremors (Stimming).",
    "choices": [
      {
        "id": "1A",
      ...
      {
        "id": "1B",
        "actionText": "[Defense Mechanism] Stay on the platform and secretly use your phone to record the station attendant's refusal as makeshift evidence.",
      ...
      {
        "id": "1C",
        "actionText": "[Fawn/Freeze] Quickly message Sammie to report the delay, even though this leaves a written paper trail against you.",
  ...
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "2B",
        "actionText": "Take a deep breath, calmly but firmly explain that the headphones are a 'necessary accommodation', and point out that constantly replying to messages breaks your coding flow.",
      ...
      {
        "id": "2C",
        "actionText": "Avoid her gaze, offer no explanat and mechanically click your mouse to open your task list, using a 'playing dead' silence to counter her attack.",
        "impactHint": "❓ High risk, unknown consequences",
        "consequenceText": "You completely shut down your external communication channels. Sammie, feeling like she punched a wall of cotton, becomes furious: 'I am talking to you, Lynn!' She eventually storms off, but this extremely dangerous confrontation leaves your heart hammering wildly.",
        "statsImpact": { "energy": -15, "sensoryOverload": 15, "managerPressure": 15 },
        "requirements": { "maxSensory": 80 },
        "disabledReason": "Sensory Overload: Under her piercing glare, your mind goes entirely blank. You can't even pretend to look at the screen."
      }
    ]
  },
  {
    ...
    "choices": [
      {
        "id": "3A",
        "actionText": "Force yourself to endure the discomfort, sit right in the middle, and aggressively Mask to laugh at every one of Sammie's jokes.",
      ...
      {
        "id": "3B",
        "actionText": "[Secret] Privately message Conrad for help, saying you can't handle this environment.",
  ...
  },
  {
    ...
    "conditionalNarrative": {
      "if_1A": "'David casually mentioned during our 1:1 that you ran in sweating and panicking this morning.' You know David likely meant no harm—it was just casual gossip—but in Sammie's mouth, it instantly becomes a bullet: 'That kind of state severely disrupts the professionalism of the office environmenurthermore, your Teams didn't turn green until 8:01. Why are you late again? Do you even respect this job?'",
      "if_1B": "'Backend data shows your Teams didn't come online until 8:01!' When you frantically try to play the recording of the subway noise to prove the delay, Sammie cuts you off with pure disgust: 'You're actually trying to use an unverifiable, chaotic recording to make excuses? This behavior of secretly recording things is highly unprofessional. Are you secretly recording me too? Why are you so hostile towards the company?'",
    ...
    "choices": [
      {
        "id": "4A",
        "actionText": "Explain that your ASD/social anxiety causes you to stutter during confrontations, and respectfully request written communication.",
      ...
      {
        "id": "4B",
        "actionText": "[Meltdown/Fawn] Break down completely in front of HR. Cry, apologize endlessly, and agree with all her accusations.",
        "impactHint": "🔋 Near zero energy | 👤 Confirm 'instability'",
        "consequenceText": "You can't stop the tears. HR hands you a tissue, but their eyesd only the wary pity reserved for an 'unstable employee'. Sammie achieved her goal—she successfully framed you as someone too emotional and unfit for the corporate environment.",
        "statsImpact": { "energy": -30, "managerPressure": 10 },
        "requirements": null,
        "disabledReason": null
      },
      {
        "id": "4C",
        "actionText": "[Dissociation] Cease all verbal response. Let your eyes unfocus and stare at a tiny crack in the wall, forcing your brain to go 'offline' to prevent a total neural burnout.",
        "impactHint": "🔊 Cut off sensory input | 👤 Abandon defense",
        "consequenceText": "The crack in the wall becomes the center of your universe. Sammie's sharp voice and HR's keyboard clacking fade into distant underwater echoes. You don't argue, you don't cry. In HR's final report, your self-preservation is documented as 'extremely apathetic and refusing to communicate.'",
        "statsImpact": { "energy": -5, "sensoryOverload": -20, "managerPressure": 25 },
        "requirements": null,
        "disabledReason": null
      }
    ]
  },
  {
    ...
    "choices": [
      ...
      {
        "id": "5C",
        "actionText": "[Fawn/Freeze] Stare blankly at the blinking cursor, paralyzed until 4:45 PM, then frantically throw together a few numberless slides in sheer panic.",
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "6A",
        "actionText": "Dig out your noise-canceling headphones, crank the white noise to max, close your eyes, and forcibly mute this cruel world.",
      ...
      {
        "id": "6B",
        "actionText": "[Extremely High Risk] Turn around and yell with a trembling voice: 'That was a human life! Do you have zero empathy?!'",
  ...
  },
  {
    ...
    "narrativeText": "In your pitch-black apartment, the cold glare of your phone screen pierces your eyes. A 'PIP Checkpoint' email, CC'd to HR, sits in your inbox. It is a cold, clinical autopsy report. Even though you pushed through hell to deliver a near-perfect presentation at 5 PM, Sammie's email reads: 'Did not meet expectations. Spoke too fast during the presentation, lacking Executive Presence. Exhibited extreme defensiveness and anxiety when receiving feedback. Furthermore, during an urgent task, you offloaded core data processing to another colleague (Conrad). This severely exposes your inability to solve problems independently and your disregard for others' workloads. Not a Team Player.' In the dark, you swear you can smell Sammie's suffocating perfume. Your eyes drift to the calendar on the wall—you are on an H1B work visa. On the PIP fails and you are terminated, you have exactly 60 days to pack up your entire life and be deported. The bridge behind you is burned; ahead lies only a cliff.",
    "choices": [
      {
        "id": "7A",
        "actionText": "[Final Struggle] Open your laptop, crying as you try to draft a 5-page email refuting Sammie's accusations point by point to prove your worth.",
        ...
        "disabledReason": "System Crash Warning: Energy fully depleted. Logic circuits disconnected. Execution failed."
      },
      {
        "id": "7B",
      ...
      },
      {
        ...
        "consequenceText": "Your heartbeat is deafening. Every external rule, every mask, the login records, Conrad's kindness, the visa countdown—they all crush you in this single moment. Your conness blurs. The UI is disintegrating... [Terminal Override Sequence Initiated]",
